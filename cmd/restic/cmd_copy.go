...
entire snapshot(s) for decrypting and encrypting.
`,
...
func init() {
	...
	f.StringVarP(&copyOptions.Host, "host", "H", "", "only consider snapshots for this `host`, when no snapshot ID is given")
